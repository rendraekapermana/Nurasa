...
public class Homepage extends AppCompatActivity implements ArticleAdapter.ArticleClickListener {
    ...
    private void fetchArticleFromFirebase() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                articleAdapter = new ArticleAdapter(Homepage.this, modelTrendingList, Homepage.this);
    ...
    @Override
    public void onArticleClick(ModelArticle article) {
        // Handle click on an article item in RecyclerView
        Intent intent = new Intent(Homepage.this, Article.class);
        // Pass relevant data to ArticleActivity
        intent.putExtra("articleTitle", article.getTvPlaceName());
        intent.putExtra("articleImage", article.getImgThumb());
        intent.putExtra("articleContent", article.getTvVote());
        startActivity(intent);
    }
}
